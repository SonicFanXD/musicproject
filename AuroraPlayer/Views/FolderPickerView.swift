...
struct FolderPickerView: View {
    ...
    /// ✅ Las tres acciones eran el MISMO bloque de ~45 líneas copiado tres veces
    /// (con 16pt de padding vertical: botones gigantes en una hoja que ahora
    /// abre a media altura). Ahora hay una sola fila reutilizable.
    private var actionButtons: some View {
        VStack(spacing: 10) {
            actionRow(
                ...
                boxFill: AppTheme.accentGradient(opacity: 0.12),
                glyph: AppTheme.accentGradient
            ) {
                importMode = .folders
                showImporter = true
            }
            ...
            actionRow(
                ...
                boxFill: Color.orange.opacity(0.12),
                glyph: Color.orange
            ) {
    ...
    private func actionRow<BoxFill: ShapeStyle, Glyph: ShapeStyle>(
        icon: String,
        title: String,
        subtitle: String,
        boxFill: BoxFill,
    ...
    /// ✅ Plegable con el contador visible en la cabecera (aunque esté cerrada).
    /// Mismo lenguaje visual que `settingsSection` de Ajustes: cabecera con icono
    /// + título sobre una tarjeta de material.
    @ViewBuilder
    private func collapsibleSection<Content: View>(
        ...
        VStack(spacing: 0) {
            Button {
                ...
                .frame(height: 44) // Touch target completo de lado a lado
                .contentShape(Rectangle())
            }
            .buttonStyle(.plain)
    ...
    /// para empezar quedaba fuera de la vista con la hoja a media altura.
