...
final class Localization: ObservableObject {
    ...
    private static let strings: [String: [Language: String]] = [
        ...
        "settings.playerBarStyle": [.spanish: "Estilo de la barra", .english: "Player bar style"],
        "settings.playerBarStyle.glass": [.spanish: "Vidrio (predeterminado)", .english: "Glass (default)"],
        "settings.playerBarStyle.solid": [.spanish: "Sólido (más fluido)", .english: "Solid (smoother)"],
        "settings.playerBarStyle.compact": [.spanish: "Compacto (altura reducida)", .english: "Compact (shorter)"],
        "settings.showPlayingIndicator": [.spanish: "Ondas en la canción actual", .english: "Waves on the current song"],
        "settings.showPlayingIndicatorSubtitle": [.spanish: "Marca la canción que suena con barras animadas; apagado, solo el título en color de acento", .english: "Marks the playing song with animated bars; off, only the title in accent color"],
        "settings.nowPlayingArtSize": [.spanish: "Tamaño de la portada", .english: "Artwork size"],
        "settings.artSize.small": [.spanish: "Pequeño", .english: "Small"],
        "settings.artSize.medium": [.spanish: "Medio (predeterminado)", .english: "Medium (default)"],
        "settings.artSize.large": [.spanish: "Grande", .english: "Large"],
        "settings.reduceMotion": [.spanish: "Reducir movimiento", .english: "Reduce motion"],
        "settings.reduceMotionSubtitle": [.spanish: "Desactiva el escalonado del splash, el rebote de las transiciones y el visualizador en movimiento", .english: "Turns off the splash stagger, bouncing transitions and the moving visualizer"],
        "settings.lyricsScrollSpeed": [.spanish: "Velocidad del scroll de letras", .english: "Lyrics scroll speed"],
        "settings.lyricsSpeed.slow": [.spanish: "Lenta", .english: "Slow"],
        "settings.lyricsSpeed.normal": [.spanish: "Normal (predeterminada)", .english: "Normal (default)"],
        "settings.lyricsSpeed.fast": [.spanish: "Rápida", .english: "Fast"],
