...
final class Localization: ObservableObject {
    ...
    /// ✅ El diccionario se construye UNA sola vez al arrancar. Antes se recreaba
    ///    en CADA llamada a `localized`: ~400 entradas nuevas por texto traducido,
    ///    que en una lista larga con scroll rápido suman miles por segundo.
    private static let strings: [String: [Language: String]] = [
        ...
        "settings.resetCache": [.spanish: "Restablecer caché de biblioteca", .english: "Reset Library Cache"],
        "settings.resetCacheSubtitle": [.spanish: "Descarta colores de portada, miniaturas e índice, y reindexa", .english: "Discards artwork colors, thumbnails and index, then reindexes"],
        "settings.resetCacheMessage": [.spanish: "Se descartarán los colores de portada, las miniaturas y el índice de búsqueda en memoria, y se reindexará la biblioteca. Tus canciones, carpetas y playlists no se tocarán. ¿Continuar?", .english: "Artwork colors, thumbnails and the in-memory search index will be discarded, and the library will be reindexed. Your songs, folders and playlists will NOT be touched. Continue?"],
        ...
        // ── NUEVO: Calidad de audio (localización completa) ──
        "quality.done": [.spanish: "Listo", .english: "Done"],
        "quality.signalChain": [.spanish: "Cadena de procesamiento", .english: "Signal Chain"],
        "quality.sourceFile": [.spanish: "Archivo fuente", .english: "Source File"],
        "quality.decoder": [.spanish: "Decodificador", .english: "Decoder"],
        "quality.audioEngine": [.spanish: "Motor de audio", .english: "Audio Engine"],
        "quality.equalizer": [.spanish: "Ecualizador", .english: "Equalizer"],
        "quality.output": [.spanish: "Salida", .english: "Output"],
        "quality.active": [.spanish: "Activo", .english: "Active"],
        "quality.bypass": [.spanish: "Bypass", .english: "Bypass"],
        "quality.lossless": [.spanish: "Lossless", .english: "Lossless"],
        "quality.compressed": [.spanish: "Comprimido", .english: "Compressed"],
        "quality.hiResAudio": [.spanish: "HI-RES AUDIO", .english: "HI-RES AUDIO"],
        "quality.losslessQuality": [.spanish: "CALIDAD LOSSLESS", .english: "LOSSLESS QUALITY"],
        "quality.compressedQuality": [.spanish: "CALIDAD COMPRIMIDA", .english: "COMPRESSED QUALITY"],
        "quality.standardQuality": [.spanish: "CALIDAD ESTÁNDAR", .english: "STANDARD QUALITY"],
        ...
        "quality.duration": [.spanish: "Duración", .english: "Duration"],
        "quality.fileSize": [.spanish: "Tamaño", .english: "File Size"],
        "quality.estBitrate": [.spanish: "Bitrate estimado", .english: "Estimated Bitrate"],
        "quality.device": [.spanish: "Dispositivo", .english: "Device"],
        "quality.model": [.spanish: "Modelo", .english: "Model"],
        "quality.system": [.spanish: "Sistema", .english: "System"],
        "quality.outputDetails": [.spanish: "Salida", .english: "Output"],
        "quality.route": [.spanish: "Ruta", .english: "Route"],
        "quality.outputFrequency": [.spanish: "Frecuencia de salida", .english: "Output Frequency"],
        "quality.outputChannels": [.spanish: "Canales de salida", .english: "Output Channels"],
        "quality.routeType": [.spanish: "Tipo de ruta", .english: "Route Type"],
        ...
        "quality.stereo": [.spanish: "Estéreo", .english: "Stereo"],
        "quality.mono": [.spanish: "Mono", .english: "Mono"],
        "quality.surround": [.spanish: "Multicanal", .english: "Surround"],
        "quality.wirelessBt": [.spanish: "Inalámbrica (Bluetooth)", .english: "Wireless (Bluetooth)"],
        "quality.wirelessAirPlay": [.spanish: "Inalámbrica (AirPlay)", .english: "Wireless (AirPlay)"],
        "quality.internalSpeaker": [.spanish: "Interna (Altavoz)", .english: "Internal (Speaker)"],
        "quality.internalReceiver": [.spanish: "Interna (Auricular)", .english: "Internal (Receiver)"],
        "quality.wiredHeadphones": [.spanish: "Conectada (Audífonos)", .english: "Wired (Headphones)"],
        "quality.wiredUsb": [.spanish: "Conectada (USB/DAC)", .english: "Wired (USB/DAC)"],
        "quality.wirelessCar": [.spanish: "Inalámbrica (Auto)", .english: "Wireless (Car)"],
        "quality.internal": [.spanish: "Interna", .english: "Internal"],
        // ✅ FASE C: spec sheet, cadena, ganancia y búfer
        "quality.codec": [.spanish: "Codec", .english: "Codec"],
        "quality.channelsPlural": [.spanish: "canales", .english: "channels"],
        "quality.decoderNative": [.spanish: "AVAudioFile (nativo)", .english: "AVAudioFile (native)"],
        "quality.decoderFallback": [.spanish: "AVPlayer (respaldo)", .english: "AVPlayer (fallback)"],
        "quality.gainProcessing": [.spanish: "Ganancia y procesamiento", .english: "Gain & Processing"],
        "quality.bufferLatency": [.spanish: "Búfer y latencia", .english: "Buffer & Latency"],
        "quality.baseGain": [.spanish: "Base de salida", .english: "Output base"],
        "quality.gainBitPerfectPossible": [.spanish: "bit-perfect posible", .english: "bit-perfect possible"],
        "quality.gainLimiter": [.spanish: "limiter", .english: "limiter"],
        "quality.effectiveGain": [.spanish: "Ganancia efectiva", .english: "Effective gain"],
        "quality.eqHeadroom": [.spanish: "Headroom del EQ", .english: "EQ headroom"],
        "quality.limiter": [.spanish: "Limiter", .english: "Limiter"],
        "quality.requestedBuffer": [.spanish: "Búfer pedido", .english: "Requested buffer"],
        "quality.bufferDecidedByIOS": [.spanish: "lo decide iOS", .english: "decided by iOS"],
        "quality.fileRate": [.spanish: "Tasa del archivo", .english: "File rate"],
        "quality.negotiatedRate": [.spanish: "Tasa negociada", .english: "Negotiated rate"],
        "quality.hardwareRate": [.spanish: "Tasa del hardware", .english: "Hardware rate"],
        "quality.routeWired": [.spanish: "Cable", .english: "Wired"],
        ...
        "eq.treble": [.spanish: "Agudos", .english: "Treble"],
        "eq.vocal": [.spanish: "Vocales", .english: "Vocal"],
        "eq.classical": [.spanish: "Clásica", .english: "Classical"],
        "eq.electronic": [.spanish: "Electrónica", .english: "Electronic"],
        ...
        "format.mp3": [.spanish: "MP3 (MPEG Layer III)", .english: "MP3 (MPEG Layer III)"],
        "format.wav": [.spanish: "WAV (PCM sin comprimir)", .english: "WAV (Uncompressed PCM)"],
        "format.aiff": [.spanish: "AIFF (PCM sin comprimir)", .english: "AIFF (Uncompressed PCM)"],
        "format.aac": [.spanish: "AAC (Advanced Audio Coding)", .english: "AAC (Advanced Audio Coding)"],
        "format.bands": [.spanish: "bandas", .english: "bands"],
        "quality.viewDetails": [.spanish: "Ver detalles de calidad de audio", .english: "View audio quality details"],
        "quality.accessibility.equalizer": [.spanish: "Ecualizador", .english: "Equalizer"],
        "quality.accessibility.lyrics": [.spanish: "Letras", .english: "Lyrics"],
